...
namespace JustCoyote
{
    ...
    public class JustCoyote : Microsoft.Xna.Framework.Game
    {
        ...
        {
            player1 = new Bike(PlayerIndex.One, new Vector2(0f, 10f), Direction.Right);
            player1 = new Bike(PlayerIndex.Two, new Vector2(GridWidth, GridHeight - 10f), Direction.Left);

            Wall.Segments[20, 20].Filled = true;
            Wall.Segments[20, 20].TextureIndex = 1;
        }
